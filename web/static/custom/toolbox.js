...
function cms_detector_api_call(url){
	...
	Swal.fire({
		title: `Detecting CMS`,
		text: `WebGuard is detecting CMS on ${url} and this may take a while. Please wait...`,
...
function waf_detector_api_call(url){
	...
	Swal.fire({
		title: `Detecting WAF`,
		text: `WebGuard is detecting WAF on ${url} and this may take a while. Please wait...`,
		allowOutsideClick: false
	});
	swal.showLoading();
	fetch(api_url, {
