!(function (l) {
  ...
  (function (i) {
    ...
    (t.prototype.selectOptionsFromConfig = function () {
      ...
      t && i(".right-bar input[type=checkbox]").prop("checked", !1);
    }),
      ...
      (t.prototype.init = function () {
        ...
        i(document).on("click", ".right-bar-toggle", function () {
          ...
          i("#dark-mode-check").change(function () {
            if (this.checked) {
              localStorage.setItem("webguard-theme", "dark");
              e.layout.changeMode("dark", !0), e.selectOptionsFromConfig();
            } else {
              localStorage.setItem("webguard-theme", null);
    ...
    (t.prototype.initControls = function () {
      ...
      (t.prototype.init = function () {
        ...
        e &&
          ...
          document
            .getElementById("main-dark-stylesheet")
            .href.includes("rtl.min.css") &&
            (document.getElementsByTagName("html")[0].dir = "rtl");
      }),
      (i.App = new t()),
